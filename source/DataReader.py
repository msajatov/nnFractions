...
class DataReader:
    ...
    def __init__(self, root_path, folds, config_parser, settings, sample_sets, data_handler):
    ...
    def read_and_process_for_training(self, sample_sets=[]):
    ...
    def prepare(self, sample_sets):
        ...
        for sset in sample_sets:
            ...
            self.sample_info_dicts.append(info_dict)
